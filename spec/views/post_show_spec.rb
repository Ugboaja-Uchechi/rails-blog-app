...
RSpec.describe 'Login', type: :feature do
  describe 'User' do
    before(:each) do
      ...
      @comment1 = Comment.create(text: 'Thank you very much for sharing your experience with us', author: @user,
                                 post: @post)
      @comment2 = Comment.create(text: "We're happy you are satisfied with the quality of our", author: @user,
                                 post: @post)
      @comment3 = Comment.create(text: 'Thank you very much for sharing your experience with us', author: @user,
                                 post: @post)
